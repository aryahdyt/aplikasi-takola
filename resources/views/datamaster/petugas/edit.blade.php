        ...
        <div class="card p-5">
            <form action="/petugas/{{ $petugas->id }}" method="post">
                ...
                <div class="form-group row mb-2 mx-5">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="nama" id="nama"
                            value="{{ old('nama', $petugas->nama_guru) }}" placeholder="Masukan Nama Petugas" required>
                    </div>
                </div>
                ...
                <div class="form-group row mb-2 mx-5">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="jabatan" id="jabatan"
                            value="{{ old('jabatan', $petugas->jabatan) }}" placeholder="Masukan Jabatan Petugas"
                            required>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="selectgroup w-100">
                            <label class="selectgroup-item">
                                <input type="radio" name="siap_bertugas" value="sanggup"
                                    {{$petugas->siap_bertugas == 'sanggup'? 'checked' : ''}} class="selectgroup-input">
                                <span class="selectgroup-button">Sanggup</span>
                            </label>
                            <label class="selectgroup-item">
                                <input type="radio" name="siap_bertugas" value="tidak"
                                    {{$petugas->siap_bertugas == 'tidak'? 'checked' : ''}} class="selectgroup-input">
                ...
                <div class="form-group row mb-2 mx-5">
                    ...
                    <div class="col-sm-12 col-md-7">
                        @if ($petugas->hari)
                        <input type="text" class="form-control mb-2" name="hariOld" id="hari"
                            value="{{ old('hariOld', $petugas->hari) }}" placeholder="Masukan Hari" readonly>
                        @endif
                ...
                <div class="form-group row mb-2 mx-5">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <textarea name="keterangan" class="form-control" id="" cols="30"
                            rows="10">{{ $petugas->keterangan }}</textarea>
                    </div>
                </div>
